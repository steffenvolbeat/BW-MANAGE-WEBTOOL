...
const DEFAULT_COLORS = { A:"#d97706", BG:"#1c1000", S2:"#241500", S3:"#2d1a00", SBG:"#160d00", CT:"#ffffff", CB:"#fde68a", CM:"#fcd34d" };
...
export default function CV_Copper() {
  const { data, setData, fontKey, setFontKey, sizeKey, setSizeKey,
         ...
         clrs, setClrs, resetStorage } = useCVStorage("copper", DEFAULT_COLORS);
