...
const DEFAULT_COLORS = { A:"#f97316", BG:"#fefce8", S2:"#fef9c3", S3:"#fef08a", SBG:"#fffde7", CT:"#1c1200", CB:"#2a1800", CM:"#a06000" };
...
export default function CV_Atomic(){
  const {data,setData,fontKey,setFontKey,sizeKey,setSizeKey,photoShapeKey,setPhotoShapeKey,photoSrc,setPhotoSrc,clrs,setClrs,resetStorage}=useCVStorage("atomic",DEFAULT_COLORS);
  ...
  <ColCtx.Provider value={clrs}>
    <div style={{minHeight:"100vh",background:"#f5e8c0",padding:"24px 16px",fontFamily:fnt}}>
      ...
      <div ref={docRef} className={`${PFX}-doc`} style={{width:850,minHeight:1202,margin:"0 auto",backgroundColor:BG,overflow:"visible",fontFamily:fnt,position:"relative",boxShadow:"0 4px 20px rgba(249,115,22,0.2)"}}>
