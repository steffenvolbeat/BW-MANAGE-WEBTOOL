...
const DEFAULT_COLORS = { A:"#2563eb", BG:"#0d1a3d", S2:"#1e2f5c", S3:"#2d4080", SBG:"#0b1535", CT:"#ffffff", CB:"#bfdbfe", CM:"#93c5fd" };
...
export default function CV_Ocean() {
  const { data, setData, fontKey, setFontKey, sizeKey, setSizeKey,
         ...
         clrs, setClrs, resetStorage } = useCVStorage("ocean", DEFAULT_COLORS);
