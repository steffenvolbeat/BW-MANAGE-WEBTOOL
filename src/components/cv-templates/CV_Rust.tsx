...
const DEFAULT_COLORS = { A:"#c2410c", BG:"#1c0800", S2:"#270d00", S3:"#341500", SBG:"#160600", CT:"#ffffff", CB:"#fed7aa", CM:"#fdba74" };
...
export default function CV_Rust() {
  const { data, setData, fontKey, setFontKey, sizeKey, setSizeKey,
         ...
         clrs, setClrs, resetStorage } = useCVStorage("rust", DEFAULT_COLORS);
