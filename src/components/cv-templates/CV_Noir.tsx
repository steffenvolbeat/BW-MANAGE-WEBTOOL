...
const DEFAULT_COLORS = { A:"#e2e8f0", BG:"#000000", S2:"#0a0a0a", S3:"#1a1a1a", SBG:"#060606", CT:"#ffffff", CB:"#f8fafc", CM:"#cbd5e1" };
...
export default function CV_Noir() {
  const { data, setData, fontKey, setFontKey, sizeKey, setSizeKey,
         ...
         clrs, setClrs, resetStorage } = useCVStorage("noir", DEFAULT_COLORS);
