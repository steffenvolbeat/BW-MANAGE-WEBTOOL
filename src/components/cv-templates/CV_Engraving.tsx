...
const DEFAULT_COLORS = { A:"#8b4513", BG:"#fdf8f0", S2:"#f5edd8", S3:"#ece0c4", SBG:"#f9f3e8", CT:"#2a1a0a", CB:"#3d2510", CM:"#8b6a40" };
...
export default function CV_Engraving(){
  const {data,setData,fontKey,setFontKey,sizeKey,setSizeKey,photoShapeKey,setPhotoShapeKey,photoSrc,setPhotoSrc,clrs,setClrs,resetStorage}=useCVStorage("engraving",DEFAULT_COLORS);
  ...
  <ColCtx.Provider value={clrs}>
    <div style={{minHeight:"100vh",background:"#e8d8c0",padding:"24px 16px",fontFamily:fnt}}>
      ...
      <div ref={docRef} className={`${PFX}-doc`} style={{width:850,minHeight:1202,margin:"0 auto",backgroundColor:BG,overflow:"visible",fontFamily:fnt,position:"relative",boxShadow:"0 4px 20px rgba(139,69,19,0.2)"}}>
