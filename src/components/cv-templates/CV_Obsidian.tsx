...
const DEFAULT_COLORS = { A:"#6b7280", BG:"#111827", S2:"#1f2937", S3:"#374151", SBG:"#161d2b", CT:"#ffffff", CB:"#d1d5db", CM:"#9ca3af" };
...
export default function CV_Obsidian() {
  const { data, setData, fontKey, setFontKey, sizeKey, setSizeKey,
         ...
         clrs, setClrs, resetStorage } = useCVStorage("obsidian", DEFAULT_COLORS);
