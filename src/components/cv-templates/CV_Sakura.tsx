...
const DEFAULT_COLORS = { A:"#f472b6", BG:"#831843", S2:"#9d174d", S3:"#be185d", SBG:"#6d1439", CT:"#ffffff", CB:"#fce7f3", CM:"#f9a8d4" };
...
export default function CV_Sakura() {
  const { data, setData, fontKey, setFontKey, sizeKey, setSizeKey,
         ...
         clrs, setClrs, resetStorage } = useCVStorage("sakura", DEFAULT_COLORS);
