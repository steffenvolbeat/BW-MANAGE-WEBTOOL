...
const DEFAULT_COLORS = { A:"#6366f1", BG:"#0f172a", S2:"#1e293b", S3:"#293548", SBG:"#162032", CT:"#f1f5f9", CB:"#cbd5e1", CM:"#64748b" };
...
export default function CV_Dashboard(){
  const {data,setData,fontKey,setFontKey,sizeKey,setSizeKey,photoShapeKey,setPhotoShapeKey,photoSrc,setPhotoSrc,clrs,setClrs,resetStorage}=useCVStorage("dashboard",DEFAULT_COLORS);
  ...
  <ColCtx.Provider value={clrs}>
    <div style={{minHeight:"100vh",background:"#080f1e",padding:"24px 16px",fontFamily:fnt}}>
      ...
      <div ref={docRef} className={`${PFX}-doc`} style={{width:850,minHeight:1202,margin:"0 auto",backgroundColor:BG,overflow:"visible",fontFamily:fnt,position:"relative",boxShadow:"0 0 40px rgba(99,102,241,0.25)"}}>
