...
const DEFAULT_COLORS = { A:"#c9a227", BG:"#fafaf5", S2:"#f5f0e0", S3:"#ede8d0", SBG:"#f8f5e8", CT:"#1a1200", CB:"#2a1e00", CM:"#806040" };
...
export default function CV_Cairo(){
  const {data,setData,fontKey,setFontKey,sizeKey,setSizeKey,photoShapeKey,setPhotoShapeKey,photoSrc,setPhotoSrc,clrs,setClrs,resetStorage}=useCVStorage("cairo",DEFAULT_COLORS);
  ...
  <ColCtx.Provider value={clrs}>
    <div style={{minHeight:"100vh",background:"#e8e0c8",padding:"24px 16px",fontFamily:fnt}}>
      ...
      <div ref={docRef} className={`${PFX}-doc`} style={{width:850,minHeight:1202,margin:"0 auto",backgroundColor:BG,overflow:"visible",fontFamily:fnt,position:"relative",boxShadow:"0 4px 20px rgba(201,162,39,0.15)"}}>
