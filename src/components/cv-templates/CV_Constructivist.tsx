...
const DEFAULT_COLORS = { A:"#dc2626", BG:"#ffffff", S2:"#f0f0f0", S3:"#e0e0e0", SBG:"#f8f8f8", CT:"#000000", CB:"#1a1a1a", CM:"#666666" };
...
export default function CV_Constructivist(){
  const {data,setData,fontKey,setFontKey,sizeKey,setSizeKey,photoShapeKey,setPhotoShapeKey,photoSrc,setPhotoSrc,clrs,setClrs,resetStorage}=useCVStorage("constructivist",DEFAULT_COLORS);
  ...
  <ColCtx.Provider value={clrs}>
    <div style={{minHeight:"100vh",background:"#e0e0e0",padding:"24px 16px",fontFamily:fnt}}>
      ...
      <div ref={docRef} className={`${PFX}-doc`} style={{width:850,minHeight:1202,margin:"0 auto",backgroundColor:BG,overflow:"visible",fontFamily:fnt,position:"relative",boxShadow:"6px 6px 0 #dc2626"}}>
