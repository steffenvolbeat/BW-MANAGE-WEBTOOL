...
const DEFAULT_COLORS = { A:"#2d6a4f", BG:"#fdfbf7", S2:"#f4f8f0", S3:"#e8f4e0", SBG:"#f8fcf4", CT:"#1a2e1a", CB:"#2d4a2d", CM:"#6a8c6a" };
...
export default function CV_Botanical(){
  const {data,setData,fontKey,setFontKey,sizeKey,setSizeKey,photoShapeKey,setPhotoShapeKey,photoSrc,setPhotoSrc,clrs,setClrs,resetStorage}=useCVStorage("botanical",DEFAULT_COLORS);
  ...
  <ColCtx.Provider value={clrs}>
    <div style={{minHeight:"100vh",background:"#e8f0e0",padding:"24px 16px",fontFamily:fnt}}>
      ...
      <div ref={docRef} className={`${PFX}-doc`} style={{width:850,minHeight:1202,margin:"0 auto",backgroundColor:BG,overflow:"visible",fontFamily:fnt,position:"relative",boxShadow:"0 4px 30px rgba(45,106,79,0.15)"}}>
