...
const DEFAULT_COLORS = { A:"#fbbf24", BG:"#0f0a00", S2:"#1c1400", S3:"#261d00", SBG:"#0c0800", CT:"#ffffff", CB:"#fde68a", CM:"#fcd34d" };
...
export default function CV_Gold() {
  const { data, setData, fontKey, setFontKey, sizeKey, setSizeKey,
         ...
         clrs, setClrs, resetStorage } = useCVStorage("gold", DEFAULT_COLORS);
