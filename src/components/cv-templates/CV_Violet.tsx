...
const DEFAULT_COLORS = { A:"#7c3aed", BG:"#1e0e3c", S2:"#28124f", S3:"#321666", SBG:"#1a0b38", CT:"#ffffff", CB:"#ede9fe", CM:"#c4b5fd" };
...
export default function CV_Violet() {
  const { data, setData, fontKey, setFontKey, sizeKey, setSizeKey,
         ...
         clrs, setClrs, resetStorage } = useCVStorage("violet", DEFAULT_COLORS);
