"use client";
// ─── Anschreiben Template: Crimson (Rot-Kraft) ────────────────────────────
...
const DEFAULT_COLORS = { A:"#ef4444", BG:"#7f1d1d", HD:"#c33a3a", S2:"#991b1b", CT:"#ffffff", CB:"#d1d5db", CM:"#9ca3af" };
...
export default function CL_Crimson() {
  const [data, setData] = usePersistentCLState<CLData>('cl_crimson_data', JSON.parse(JSON.stringify(DEFAULT_CL_DATA)));
  const [editing, setEditing] = useState(false);
  const [fontKey, setFontKey] = usePersistentCLState('cl_crimson_font', "nunito");
  const [sizeKey, setSizeKey] = usePersistentCLState('cl_crimson_size', "md");
  const [showDesign, setShowDesign] = useState(false);
  const [clrs, setClrs] = usePersistentCLState('cl_crimson_colors', DEFAULT_COLORS);
  ...
  <ColCtx.Provider value={clrs}>
    <div style={{ minHeight: "100vh", background: "#111", padding: "24px 16px", fontFamily: fnt }}>
      <style>{`
        ...
        .clcri-doc, .clcri-doc * { font-family: ${fnt} !important; }
        @media print {
          ...
          *, *::before, *::after { -webkit-print-color-adjust: exact !important; print-color-adjust: exact !important; color-adjust: exact !important; }
          ...
          .clcri-doc, .clcri-doc * { visibility: visible !important; }
          .clcri-doc { position: absolute !important; top: 0 !important; left: 0 !important; width: 850px !important; min-height: 1202px !important; overflow: hidden !important; zoom: 0.934 !important; box-shadow: none !important; margin: 0 !important; }
          .clcri-zoom { zoom: 1 !important; width: 100% !important; }
          .clcri-ctrl { display: none !important; }
        }
      `}</style>
      ...
      <div className="clcri-doc" style={{ width: 850, margin: "0 auto", backgroundColor: BG, boxShadow: `0 0 60px ${hex2rgba(A,0.15)}`, overflow: "hidden" }}>
