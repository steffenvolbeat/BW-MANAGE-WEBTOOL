...
const DEFAULT_COLORS = { A:"#8b2252", BG:"#fdf6e3", S2:"#f8edd8", S3:"#f2e4cc", SBG:"#faf3e8", CT:"#2a0a18", CB:"#3a1020", CM:"#886070" };
...
export default function CV_Manuscript(){
  const {data,setData,fontKey,setFontKey,sizeKey,setSizeKey,photoShapeKey,setPhotoShapeKey,photoSrc,setPhotoSrc,clrs,setClrs,resetStorage}=useCVStorage("manuscript",DEFAULT_COLORS);
  ...
  <ColCtx.Provider value={clrs}>
    <div style={{minHeight:"100vh",background:"#e8d8c0",padding:"24px 16px",fontFamily:fnt}}>
      ...
      <div ref={docRef} className={`${PFX}-doc`} style={{width:850,minHeight:1202,margin:"0 auto",backgroundColor:BG,overflow:"visible",fontFamily:fnt,position:"relative",boxShadow:"0 4px 20px rgba(139,34,82,0.15)"}}>
