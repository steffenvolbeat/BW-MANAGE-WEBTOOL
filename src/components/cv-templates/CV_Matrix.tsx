...
const DEFAULT_COLORS = { A:"#4ade80", BG:"#052e16", S2:"#064e3b", S3:"#065f46", SBG:"#042f2e", CT:"#ffffff", CB:"#bbf7d0", CM:"#86efac" };
...
export default function CV_Matrix() {
  const { data, setData, fontKey, setFontKey, sizeKey, setSizeKey,
         ...
         clrs, setClrs, resetStorage } = useCVStorage("matrix", DEFAULT_COLORS);
