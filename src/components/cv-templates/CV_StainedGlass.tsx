...
const DEFAULT_COLORS = { A:"#f59e0b", BG:"#1a0a00", S2:"#240e00", S3:"#301500", SBG:"#1e0c00", CT:"#fff8e8", CB:"#f0d8a0", CM:"#c09040" };
...
export default function CV_StainedGlass(){
  const {data,setData,fontKey,setFontKey,sizeKey,setSizeKey,photoShapeKey,setPhotoShapeKey,photoSrc,setPhotoSrc,clrs,setClrs,resetStorage}=useCVStorage("stainedglass",DEFAULT_COLORS);
  ...
  <ColCtx.Provider value={clrs}>
    <div style={{minHeight:"100vh",background:"#100600",padding:"24px 16px",fontFamily:fnt}}>
      ...
      <div ref={docRef} className={`${PFX}-doc`} style={{width:850,minHeight:1202,margin:"0 auto",backgroundColor:BG,overflow:"visible",fontFamily:fnt,position:"relative",boxShadow:"0 0 40px rgba(245,158,11,0.3)"}}>
