...
const DEFAULT_COLORS = { A:"#6b7280", BG:"#f9fafb", S2:"#f3f4f6", S3:"#e5e7eb", SBG:"#f7f8fa", CT:"#111827", CB:"#374151", CM:"#6b7280" };
...
export default function CV_Marble() {
  const { data, setData, fontKey, setFontKey, sizeKey, setSizeKey,
         ...
         clrs, setClrs, resetStorage } = useCVStorage("marble", DEFAULT_COLORS);
