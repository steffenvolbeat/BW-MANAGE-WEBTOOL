...
const DEFAULT_COLORS = { A:"#22d3ee", BG:"#0c1a22", S2:"#0f2430", S3:"#162e3e", SBG:"#0a1820", CT:"#ffffff", CB:"#cffafe", CM:"#67e8f9" };
...
export default function CV_Neon() {
  const { data, setData, fontKey, setFontKey, sizeKey, setSizeKey,
         ...
         clrs, setClrs, resetStorage } = useCVStorage("neon", DEFAULT_COLORS);
