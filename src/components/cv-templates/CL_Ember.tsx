...
export default function CL_Ember() {
  ...
  return (
    <div style={{ minHeight: "100vh", background: "#1a0600", padding: "24px 16px", fontFamily: fnt }}>
      <style>{`
        ...
        .clemb-doc, .clemb-doc * { font-family: ${fnt} !important; }
        @media print {
          @page { size: A4 portrait; margin: 0; }
          body * { visibility: hidden !important; }
          .clemb-doc, .clemb-doc * { visibility: visible !important; }
          .clemb-doc { position: absolute !important; top: 0 !important; left: 0 !important; width: 210mm !important; box-shadow: none !important; margin: 0 !important; -webkit-print-color-adjust: exact !important; print-color-adjust: exact !important; }
          .clemb-zoom { zoom: 1 !important; width: 100% !important; }
          .clemb-ctrl { display: none !important; }
        }
      `}</style>
      <div className="clemb-ctrl" style={{ maxWidth: 850, margin: "0 auto 16px", display: "flex", gap: 8, flexWrap: "wrap" }}>
      ...
      <div className="clemb-doc" style={{ width: 850, margin: "0 auto", backgroundColor: BG, boxShadow: `0 0 60px rgba(251,146,60,0.15)`, overflow: "hidden" }}>
        <div className="clemb-zoom" style={{ width: Math.round(850 / scale), zoom: scale }}>
          {/* Header */}
