...
const DEFAULT_COLORS = { A:"#9ca3af", BG:"#1f2937", S2:"#374151", S3:"#4b5563", SBG:"#1a2433", CT:"#ffffff", CB:"#d1d5db", CM:"#9ca3af" };
...
export default function CV_Graphite() {
  const { data, setData, fontKey, setFontKey, sizeKey, setSizeKey,
         ...
         clrs, setClrs, resetStorage } = useCVStorage("graphite", DEFAULT_COLORS);
