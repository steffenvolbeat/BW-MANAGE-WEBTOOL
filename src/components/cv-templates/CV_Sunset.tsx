...
const DEFAULT_COLORS = { A:"#fb923c", BG:"#1a0505", S2:"#220a00", S3:"#2d1000", SBG:"#180300", CT:"#ffffff", CB:"#fed7aa", CM:"#fdba74" };
...
export default function CV_Sunset() {
  const { data, setData, fontKey, setFontKey, sizeKey, setSizeKey,
         ...
         clrs, setClrs, resetStorage } = useCVStorage("sunset", DEFAULT_COLORS);
