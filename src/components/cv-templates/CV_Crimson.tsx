...
const DEFAULT_COLORS = { A:"#ef4444", BG:"#7f1d1d", S2:"#991b1b", S3:"#b91c1c", SBG:"#6b1c1c", CT:"#ffffff", CB:"#fecaca", CM:"#f87171" };
...
export default function CV_Crimson() {
  const { data, setData, fontKey, setFontKey, sizeKey, setSizeKey,
         ...
         clrs, setClrs, resetStorage } = useCVStorage("crimson", DEFAULT_COLORS);
