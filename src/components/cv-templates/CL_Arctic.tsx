...
const DEFAULT_COLORS = { A:"#0ea5e9", BG:"#f0f9ff", S2:"#e0f2fe" };
  ...
  <ColCtx.Provider value={clrs}>
    <div style={{ minHeight: "100vh", background: "#f0f0f0", padding: "24px 16px", fontFamily: fnt }}>
      <style>{`
        ...
        .clarc-doc, .clarc-doc * { font-family: ${fnt} !important; }
        @media print {
          @page { size: A4 portrait; margin: 0; }
          body * { visibility: hidden !important; }
          .clarc-doc, .clarc-doc * { visibility: visible !important; }
          .clarc-doc { position: absolute !important; top: 0 !important; left: 0 !important; width: 210mm !important; box-shadow: none !important; margin: 0 !important; -webkit-print-color-adjust: exact !important; print-color-adjust: exact !important; }
          .clarc-zoom { zoom: 1 !important; width: 100% !important; }
          .clarc-ctrl { display: none !important; }
        }
      `}</style>
      ...
      <div className="clarc-doc" style={{ width: 850, margin: "0 auto", backgroundColor: BG, boxShadow: `0 0 60px rgba(14,165,233,0.15)`, overflow: "hidden" }}>
        <div className="clarc-zoom" style={{ width: Math.round(850 / scale), zoom: scale }}>
          {/* Header */}
          <div style={{ background: `linear-gradient(135deg, ${BG}, "#e0f2fe")`, padding: "32px 48px 24px", borderBottom: `2px solid ${A}` }}>
