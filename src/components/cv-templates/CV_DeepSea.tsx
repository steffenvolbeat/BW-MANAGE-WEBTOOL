...
const DEFAULT_COLORS = { A:"#00e5ff", BG:"#000d1a", S2:"#001428", S3:"#001e38", SBG:"#001020", CT:"#e0f8ff", CB:"#a0d8ee", CM:"#406888" };
...
export default function CV_DeepSea(){
  const {data,setData,fontKey,setFontKey,sizeKey,setSizeKey,photoShapeKey,setPhotoShapeKey,photoSrc,setPhotoSrc,clrs,setClrs,resetStorage}=useCVStorage("deepsea",DEFAULT_COLORS);
  ...
  <ColCtx.Provider value={clrs}>
    <div style={{minHeight:"100vh",background:"#000810",padding:"24px 16px",fontFamily:fnt}}>
      ...
      <div ref={docRef} className={`${PFX}-doc`} style={{width:850,minHeight:1202,margin:"0 auto",backgroundColor:BG,overflow:"visible",fontFamily:fnt,position:"relative",boxShadow:"0 0 60px rgba(0,229,255,0.15)"}}>
