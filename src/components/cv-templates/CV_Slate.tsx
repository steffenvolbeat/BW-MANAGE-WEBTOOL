...
const DEFAULT_COLORS = { A:"#94a3b8", BG:"#0f172a", S2:"#1e293b", S3:"#334155", SBG:"#0d1525", CT:"#ffffff", CB:"#e2e8f0", CM:"#94a3b8" };
...
export default function CV_Slate() {
  const { data, setData, fontKey, setFontKey, sizeKey, setSizeKey,
         ...
         clrs, setClrs, resetStorage } = useCVStorage("slate", DEFAULT_COLORS);
