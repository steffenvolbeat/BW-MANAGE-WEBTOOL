...
const DEFAULT_COLORS = { A:"#4caf50", BG:"#f5fff0", S2:"#e8f8e0", S3:"#d8f0c8", SBG:"#f0fce8", CT:"#0a2a00", CB:"#1a3a0a", CM:"#5a8a4a" };
...
export default function CV_Solarpunk(){
  const {data,setData,fontKey,setFontKey,sizeKey,setSizeKey,photoShapeKey,setPhotoShapeKey,photoSrc,setPhotoSrc,clrs,setClrs,resetStorage}=useCVStorage("solarpunk",DEFAULT_COLORS);
  ...
  <ColCtx.Provider value={clrs}>
    <div style={{minHeight:"100vh",background:"#d8f0c8",padding:"24px 16px",fontFamily:fnt}}>
      ...
      <div ref={docRef} className={`${PFX}-doc`} style={{width:850,minHeight:1202,margin:"0 auto",backgroundColor:BG,overflow:"visible",fontFamily:fnt,position:"relative",boxShadow:"0 4px 30px rgba(76,175,80,0.2)"}}>
