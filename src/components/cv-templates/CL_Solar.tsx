...
const DEFAULT_COLORS = { A:"#f97316", BG:"#431407", S2:"#5c1d0a" };
    ...
    <div style={{ minHeight: "100vh", background: "#111", padding: "24px 16px", fontFamily: fnt }}>
      <style>{`
        ...
        @media print {
          ...
          .clsol-doc { position: absolute !important; top: 0 !important; left: 0 !important; width: 210mm !important; box-shadow: none !important; margin: 0 !important; -webkit-print-color-adjust: exact !important; print-color-adjust: exact !important; }
      ...
      <div className="clsol-doc" style={{ width: 850, margin: "0 auto", backgroundColor: BG, boxShadow: `0 0 60px rgba(249,115,22,0.15)`, overflow: "hidden" }}>
        <div className="clsol-zoom" style={{ width: Math.round(850 / scale), zoom: scale }}>
          {/* Header */}
          <div style={{ background: `linear-gradient(135deg, ${BG}, "#5c1d0a")`, padding: "32px 48px 24px", borderBottom: `2px solid ${A}` }}>
