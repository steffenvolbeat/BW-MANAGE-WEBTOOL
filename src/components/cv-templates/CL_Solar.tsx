...
const DEFAULT_COLORS = { A:"#f97316", BG:"#431407", HD:"#6f2e1b", S2:"#5c1d0a", CT:"#ffffff", CB:"#d1d5db", CM:"#9ca3af" };
...
export default function CL_Solar() {
  const [data, setData] = usePersistentCLState<CLData>('cl_solar_data', JSON.parse(JSON.stringify(DEFAULT_CL_DATA)));
  const [editing, setEditing] = useState(false);
  const [fontKey, setFontKey] = usePersistentCLState('cl_solar_font', "nunito");
  const [sizeKey, setSizeKey] = usePersistentCLState('cl_solar_size', "md");
  const [showDesign, setShowDesign] = useState(false);
  const [clrs, setClrs] = usePersistentCLState('cl_solar_colors', DEFAULT_COLORS);
  ...
  <ColCtx.Provider value={clrs}>
    <div style={{ minHeight: "100vh", background: "#111", padding: "24px 16px", fontFamily: fnt }}>
      <style>{`
        ...
        .clsol-doc, .clsol-doc * { font-family: ${fnt} !important; }
        @media print {
          ...
          *, *::before, *::after { -webkit-print-color-adjust: exact !important; print-color-adjust: exact !important; color-adjust: exact !important; }
          ...
          .clsol-doc, .clsol-doc * { visibility: visible !important; }
          .clsol-doc { position: absolute !important; top: 0 !important; left: 0 !important; width: 850px !important; min-height: 1202px !important; overflow: hidden !important; zoom: 0.934 !important; box-shadow: none !important; margin: 0 !important; }
          .clsol-zoom { zoom: 1 !important; width: 100% !important; }
          .clsol-ctrl { display: none !important; }
        }
      `}</style>
      ...
      <div className="clsol-doc" style={{ width: 850, margin: "0 auto", backgroundColor: BG, boxShadow: `0 0 60px ${hex2rgba(A,0.15)}`, overflow: "hidden" }}>
