...
const DEFAULT_COLORS = { A:"#a8a29e", BG:"#1c1917", S2:"#292524", S3:"#44403c", SBG:"#171412", CT:"#ffffff", CB:"#e7e5e4", CM:"#a8a29e" };
...
export default function CV_Smoke() {
  const { data, setData, fontKey, setFontKey, sizeKey, setSizeKey,
         ...
         clrs, setClrs, resetStorage } = useCVStorage("smoke", DEFAULT_COLORS);
