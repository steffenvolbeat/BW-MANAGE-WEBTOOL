...
const DEFAULT_COLORS = { A:"#3b82f6", BG:"#1e3a5f", S2:"#1e40af", S3:"#2563eb", SBG:"#172d4f", CT:"#ffffff", CB:"#bfdbfe", CM:"#93c5fd" };
...
export default function CV_Navy() {
  const { data, setData, fontKey, setFontKey, sizeKey, setSizeKey,
         ...
         clrs, setClrs, resetStorage } = useCVStorage("navy", DEFAULT_COLORS);
