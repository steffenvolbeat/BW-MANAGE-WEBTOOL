...
const DEFAULT_COLORS = { A:"#38bdf8", BG:"#f0f9ff", S2:"#e0f2fe", S3:"#bae6fd", SBG:"#f7faff", CT:"#0c4a6e", CB:"#0369a1", CM:"#0284c7" };
...
export default function CV_Arctic() {
  const { data, setData, fontKey, setFontKey, sizeKey, setSizeKey,
         ...
         clrs, setClrs, resetStorage } = useCVStorage("arctic", DEFAULT_COLORS);
