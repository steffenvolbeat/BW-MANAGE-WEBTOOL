...
const DEFAULT_COLORS = { A:"#fb7185", BG:"#1f0a14", S2:"#2d0d1e", S3:"#3b102a", SBG:"#1a0810", CT:"#ffffff", CB:"#fce7f3", CM:"#f9a8d4" };
...
export default function CV_Coral() {
  const { data, setData, fontKey, setFontKey, sizeKey, setSizeKey,
         ...
         clrs, setClrs, resetStorage } = useCVStorage("coral", DEFAULT_COLORS);
