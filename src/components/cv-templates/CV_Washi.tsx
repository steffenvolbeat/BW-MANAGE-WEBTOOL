...
const DEFAULT_COLORS = { A:"#e06c9e", BG:"#fffaf5", S2:"#fff0f5", S3:"#ffe8f0", SBG:"#fff5f8", CT:"#3d1a2a", CB:"#5a2a3a", CM:"#c08898" };
...
export default function CV_Washi(){
  const {data,setData,fontKey,setFontKey,sizeKey,setSizeKey,photoShapeKey,setPhotoShapeKey,photoSrc,setPhotoSrc,clrs,setClrs,resetStorage}=useCVStorage("washi",DEFAULT_COLORS);
  ...
  <ColCtx.Provider value={clrs}>
    <div style={{minHeight:"100vh",background:"#f5e8ee",padding:"24px 16px",fontFamily:fnt}}>
      ...
      <div ref={docRef} className={`${PFX}-doc`} style={{width:850,minHeight:1202,margin:"0 auto",backgroundColor:BG,overflow:"visible",fontFamily:fnt,position:"relative",boxShadow:"0 4px 20px rgba(224,108,158,0.15)"}}>
