...
const DEFAULT_COLORS = { A:"#f97316", BG:"#431407", S2:"#591b08", S3:"#7c2d12", SBG:"#3d1005", CT:"#ffffff", CB:"#fed7aa", CM:"#fdba74" };
...
export default function CV_Solar() {
  const { data, setData, fontKey, setFontKey, sizeKey, setSizeKey,
         ...
         clrs, setClrs, resetStorage } = useCVStorage("solar", DEFAULT_COLORS);
