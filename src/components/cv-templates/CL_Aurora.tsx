...
const DEFAULT_COLORS = { A:"#a855f7", BG:"#1e1b4b", S2:"#2d2655" };
    ...
    <div style={{ minHeight: "100vh", background: "#111", padding: "24px 16px", fontFamily: fnt }}>
      <style>{`
        ...
        @media print {
          ...
          .claur-doc { position: absolute !important; top: 0 !important; left: 0 !important; width: 210mm !important; box-shadow: none !important; margin: 0 !important; -webkit-print-color-adjust: exact !important; print-color-adjust: exact !important; }
      ...
      <div className="claur-doc" style={{ width: 850, margin: "0 auto", backgroundColor: BG, boxShadow: `0 0 60px rgba(168,85,247,0.15)`, overflow: "hidden" }}>
        <div className="claur-zoom" style={{ width: Math.round(850 / scale), zoom: scale }}>
          {/* Header */}
          <div style={{ background: `linear-gradient(135deg, ${BG}, "#2d2655")`, padding: "32px 48px 24px", borderBottom: `2px solid ${A}` }}>
