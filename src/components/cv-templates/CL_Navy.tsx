    ...
    <div style={{ minHeight: "100vh", background: "#1e3a5f", padding: "24px 16px", fontFamily: fnt }}>
      <style>{`
        ...
        @media print {
          ...
          .clnav-doc { position: absolute !important; top: 0 !important; left: 0 !important; width: 210mm !important; box-shadow: none !important; margin: 0 !important; -webkit-print-color-adjust: exact !important; print-color-adjust: exact !important; }
      ...
      <div className="clnav-doc" style={{ width: 850, margin: "0 auto", backgroundColor: BG, boxShadow: `0 0 60px rgba(59,130,246,0.15)`, overflow: "hidden" }}>
