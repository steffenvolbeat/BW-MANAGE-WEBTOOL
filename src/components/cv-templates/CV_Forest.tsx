...
const DEFAULT_COLORS = { A:"#22c55e", BG:"#14532d", S2:"#1a6b35", S3:"#1f7a3a", SBG:"#163d25", CT:"#ffffff", CB:"#bbf7d0", CM:"#86efac" };
...
export default function CV_Forest() {
  const { data, setData, fontKey, setFontKey, sizeKey, setSizeKey,
         ...
         clrs, setClrs, resetStorage } = useCVStorage("forest", DEFAULT_COLORS);
