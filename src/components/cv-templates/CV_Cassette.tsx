...
const DEFAULT_COLORS = { A:"#f0e000", BG:"#0a0a0a", S2:"#141414", S3:"#1e1e1e", SBG:"#111111", CT:"#ffffff", CB:"#e0e0e0", CM:"#888888" };
...
export default function CV_Cassette(){
  const {data,setData,fontKey,setFontKey,sizeKey,setSizeKey,photoShapeKey,setPhotoShapeKey,photoSrc,setPhotoSrc,clrs,setClrs,resetStorage}=useCVStorage("cassette",DEFAULT_COLORS);
  ...
  <ColCtx.Provider value={clrs}>
    <div style={{minHeight:"100vh",background:"#050505",padding:"24px 16px",fontFamily:fnt}}>
      ...
      <div ref={docRef} className={`${PFX}-doc`} style={{width:850,minHeight:1202,margin:"0 auto",backgroundColor:BG,overflow:"visible",fontFamily:fnt,position:"relative",boxShadow:"0 0 30px rgba(240,224,0,0.2)"}}>
