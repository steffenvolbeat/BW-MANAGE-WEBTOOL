...
const DEFAULT_COLORS = { A:"#fb923c", BG:"#1a0600", S2:"#220800", S3:"#2d0e00", SBG:"#180500", CT:"#ffffff", CB:"#fed7aa", CM:"#fdba74" };
...
export default function CV_Ember() {
  const { data, setData, fontKey, setFontKey, sizeKey, setSizeKey,
         ...
         clrs, setClrs, resetStorage } = useCVStorage("ember", DEFAULT_COLORS);
