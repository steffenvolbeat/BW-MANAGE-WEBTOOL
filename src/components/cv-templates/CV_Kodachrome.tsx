...
const DEFAULT_COLORS = { A:"#e53935", BG:"#fffdf8", S2:"#fff8f0", S3:"#fff0e8", SBG:"#fffaf5", CT:"#1a0a00", CB:"#2a1000", CM:"#a06050" };
...
export default function CV_Kodachrome(){
  const {data,setData,fontKey,setFontKey,sizeKey,setSizeKey,photoShapeKey,setPhotoShapeKey,photoSrc,setPhotoSrc,clrs,setClrs,resetStorage}=useCVStorage("kodachrome",DEFAULT_COLORS);
  ...
  <ColCtx.Provider value={clrs}>
    <div style={{minHeight:"100vh",background:"#f0e8d8",padding:"24px 16px",fontFamily:fnt}}>
      ...
      <div ref={docRef} className={`${PFX}-doc`} style={{width:850,minHeight:1202,margin:"0 auto",backgroundColor:BG,overflow:"visible",fontFamily:fnt,position:"relative",boxShadow:"0 4px 20px rgba(229,57,53,0.2)"}}>
