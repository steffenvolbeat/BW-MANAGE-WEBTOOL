...
const DEFAULT_COLORS = { A:"#059669", BG:"#f0fdf4", S2:"#dcfce7", S3:"#bbf7d0", SBG:"#f0fdf7", CT:"#064e3b", CB:"#065f46", CM:"#047857" };
...
export default function CV_Jade() {
  const { data, setData, fontKey, setFontKey, sizeKey, setSizeKey,
         ...
         clrs, setClrs, resetStorage } = useCVStorage("jade", DEFAULT_COLORS);
