...
const DEFAULT_COLORS = { A:"#a855f7", BG:"#1e1b4b", S2:"#2d2655", S3:"#3d3470", SBG:"#241f64", CT:"#ffffff", CB:"#e9d5ff", CM:"#c4b5fd" };
...
export default function CV_Aurora() {
  const { data, setData, fontKey, setFontKey, sizeKey, setSizeKey,
         ...
         clrs, setClrs, resetStorage } = useCVStorage("aurora", DEFAULT_COLORS);
