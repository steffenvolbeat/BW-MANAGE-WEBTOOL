...
const DEFAULT_COLORS = { A:"#6366f1", BG:"#f4f4f5", S2:"#e4e4e7", S3:"#d4d4d8", SBG:"#fafafa", CT:"#18181b", CB:"#3f3f46", CM:"#a1a1aa" };
...
export default function CV_Bento(){
  const {data,setData,fontKey,setFontKey,sizeKey,setSizeKey,photoShapeKey,setPhotoShapeKey,photoSrc,setPhotoSrc,clrs,setClrs,resetStorage}=useCVStorage("bento",DEFAULT_COLORS);
  ...
  <ColCtx.Provider value={clrs}>
    <div style={{minHeight:"100vh",background:"#e8e8ec",padding:"24px 16px",fontFamily:fnt}}>
      ...
      <div ref={docRef} className={`${PFX}-doc`} style={{width:850,minHeight:1202,margin:"0 auto",backgroundColor:BG,overflow:"visible",fontFamily:fnt,position:"relative",boxShadow:"0 4px 24px rgba(0,0,0,0.1)"}}>
