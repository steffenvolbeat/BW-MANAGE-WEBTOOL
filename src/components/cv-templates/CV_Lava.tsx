...
const DEFAULT_COLORS = { A:"#ff6b35", BG:"#0a0015", S2:"#120020", S3:"#1a0030", SBG:"#0e001a", CT:"#ffe8d8", CB:"#f0c0a0", CM:"#a06040" };
...
export default function CV_Lava(){
  const {data,setData,fontKey,setFontKey,sizeKey,setSizeKey,photoShapeKey,setPhotoShapeKey,photoSrc,setPhotoSrc,clrs,setClrs,resetStorage}=useCVStorage("lava",DEFAULT_COLORS);
  ...
  <ColCtx.Provider value={clrs}>
    <div style={{minHeight:"100vh",background:"#050008",padding:"24px 16px",fontFamily:fnt}}>
      ...
      <div ref={docRef} className={`${PFX}-doc`} style={{width:850,minHeight:1202,margin:"0 auto",backgroundColor:BG,overflow:"visible",fontFamily:fnt,position:"relative",boxShadow:"0 0 60px rgba(255,107,53,0.3)"}}>
